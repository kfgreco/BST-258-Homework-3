...
&\Rightarrow \hat{\beta}=\frac{\frac{1}{ n} \sum_{i=1}^n Y_iA_i+\alpha \bar{A}}{\bar{A}} = \frac{\frac{1}{ n} \sum_{i=1}^n Y_iA_i+\left(\bar{Y}-\hat{\beta}\bar{A}\right) \bar{A}}{\bar{A}} =
\frac{\frac{1}{ n} \sum_{i=1}^n Y_iA_i+\bar{Y}\bar{A}-\hat{\beta}\bar{A}^2}{\bar{A}}
\end{aligned}
$$
...
Now, plugging in our expression for $\hat{\alpha}$ into $\hat{\beta}$:

$$
\hat{\beta}= \frac{ \sum_{i=1}^n A_i\left(Y_i-\frac{1}{ n}\sum_{i=1}^n\left( Y_i-\hat{\beta} A_i\right) \right)}{m}
$$
